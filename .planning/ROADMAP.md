...
Plans:
- [ ] 02-01: プレイヤー追跡コマンドとバリデーションを追加する
- [ ] 02-02: 中断コマンドと追跡状態クリアを実装する
...
Plans:
- [ ] 03-01: tick 時の追跡継続/再計画ロジックを追加する
...
Plans:
- [ ] 04-01: pursuit イベントの recipient/formatter/registry wiring を追加する
- [ ] 04-02: LLM 再駆動に必要な structured payload を整える
- [ ] 04-03: interruption と outcome の統合テストを追加する
...
|-------|----------------|--------|-----------|
| 1. Pursuit Domain Vocabulary | 0/3 | Not started | - |
