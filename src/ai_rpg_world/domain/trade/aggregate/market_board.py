...
売り 20G と買い 22G が板に並んでも、engine は潰さない。**線は「手番の外か」
ではなく「引き金に人が居るか」**にある。

| 形 | 可否 | なぜ |
|---|---|---|
| 誰かが自分の注文を取ったから動いた | よい | **引き金に人が居る**。通知も届く |
| engine が両者を勝手に選んで約定させた | だめ | **引き金に誰も居ない**。裁定に気づく機会が消える |

世界が自分の手番の外で変わってよい。実際、板越しの取引では自分が居ない場所で
自分の品が売れる。問題は変わったことではなく、**変えた人が居ないこと**である。
