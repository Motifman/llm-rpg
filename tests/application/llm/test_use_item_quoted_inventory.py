...
- inventory display は ``- 流木 x3 (素材・そのままは食べられない。焚き火などの材料) (腐敗)`` のような
...
1. **inventory 表示**: ``- "流木" x3 (素材・そのままは食べられない。焚き火などの材料) (腐敗)`` のように
...
class TestPromptQuotesInventoryItemName:
    ...
    def test_inventory(self) -> None:
        ...
        assert '"(素材・そのままは食べられない。焚き火などの材料)"' not in text
