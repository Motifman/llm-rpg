...
def _actor_from_observation_structured(structured: Mapping[str, Any]) -> str | None:
    """観測 structured から episode.who 用 actor marker を作る。

    対象専用文面で秘匿された対人観測では、structured["actor"] に実 actor が
