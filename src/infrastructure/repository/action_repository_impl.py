...
class ActionRepositoryImpl(ActionRepository):
    ...
    def _setup_initial_data(self):
        ...
        from src.domain.battle.battle_action import AttackAction, HealAction, DefendAction
        from src.domain.battle.battle_enum import ActionType, TargetSelectionMethod, Element
