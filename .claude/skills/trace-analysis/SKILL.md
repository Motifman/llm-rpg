...
- G-46 gold の出入りと滞留 (商人との境界をまたいだ額)。DEPOSIT_GOLD/ITEM_TO_OBJECT (祭壇などへの退蔵) は流通から消えるが object.state に残る — 保存則の分母から除き、値は action_result の `object_state_changes` から引く
