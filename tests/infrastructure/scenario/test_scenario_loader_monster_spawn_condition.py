"""parse_monster_spawn_condition の検証 (Phase B-2b)。
...
from ai_rpg_world.infrastructure.scenario.parse_actors import parse_monster_spawn_condition
...
class TestParseMonsterSpawnCondition:
    ...
    def test_returns_none(self) -> None:
        ...
        result = parse_monster_spawn_condition(None, 0)
        assert result is None

    def test_day_night_phases_string_tuple(self) -> None:
        """day night phases を文字列タプルに変換。"""
        result = parse_monster_spawn_condition(
    ...
    def test_returns_empty_when_all_is_always_true(self) -> None:
        ...
        result = parse_monster_spawn_condition({}, 0)
    ...
    def test_dict_spawn_condition_scenario_load_error(self) -> None:
        ...
        with pytest.raises(ScenarioLoadError):
            parse_monster_spawn_condition("night", 0)
