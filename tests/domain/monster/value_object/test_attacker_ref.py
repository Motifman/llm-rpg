...
class TestAttackerRefFactories:
    ...
    def test_of_monster_sets_kind_and_monster_id(self) -> None:
    ...
    def test_of_player_sets_kind_and_player_id(self) -> None:
...
class TestAttackerRefValidation:
    ...
    def test_monster_kind_monster_id_none_raises_exception(self) -> None:
    ...
    def test_monster_kind_player_id_raises_exception(self) -> None:
    ...
    def test_player_kind_player_id_none_raises_exception(self) -> None:
        """kind=PLAYER 時に player_id を渡さないと ValidationException を投げる。"""
        with pytest.raises(AttackerRefValidationException):
            AttackerRef(kind=AttackerKind.PLAYER, player_id=None)

    def test_player_kind_monster_id_raises_exception(self) -> None:
