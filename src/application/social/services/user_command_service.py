...
from src.application.social.exceptions import (
    SystemErrorException,
    UserCommandException,
    ApplicationExceptionFactory,
)
from src.application.social.exceptions.command.user_command_exception import UserNotFoundForCommandException
