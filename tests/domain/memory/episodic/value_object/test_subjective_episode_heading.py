...
def _episode(**overrides) -> SubjectiveEpisode:
    ...
    """
    base = dict(episode_id='ep-1', player_id=1, being_id=BeingId('being_w1_p1'), occurred_at=datetime(2026, 7, 1, tzinfo=timezone.utc), game_time_label=None, source=EpisodeSource(event_ids=('evt-1',)), location=EpisodeLocation(), action=EpisodeAction(tool_name='t'), who=('p',), what='w', why=None, observed='o', expected=None, outcome='ok', prediction_error=None, felt=None, interpreted=None, cues=(), recall_text=None)
