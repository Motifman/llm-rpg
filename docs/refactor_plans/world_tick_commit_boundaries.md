...
| 6 | weather | 遷移1回 | weather state、専用乱数状態 | 天候観測はcommit後・最善努力 | 済 #1243第8段 |
| 7 | day/night | 遷移1回 | current time-of-day | 変化観測はcommit後・最善努力 | 済 #1243第8段 |
...
7. spoilage / expiry / outcome: 次にfood spoilageから状態とcallbackを順次分離する。
