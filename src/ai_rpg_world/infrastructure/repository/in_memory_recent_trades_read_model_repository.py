"""
InMemoryRecentTradesReadModelRepository - RecentTradesReadModelを使用するインメモリ実装
"""
from typing import List, Optional, Dict
from datetime import datetime, timedelta
import random
from ai_rpg_world.domain.trade.repository.recent_trade_read_model_repository import RecentTradeReadModelRepository
...
class InMemoryRecentTradeReadModelRepository(RecentTradeReadModelRepository):
    """RecentTradesReadModelを使用するインメモリリポジトリ"""
    ...
    def _setup_sample_data(self):
        ...
        # 取引履歴がないアイテムもテスト用に作成
        legendary_sword = RecentTradesReadModel.create_from_item_and_trades(
    ...
    def _create_sample_recent_trades(
        ...
        return RecentTradesReadModel.create_from_item_and_trades(
    ...
    # Repository基本メソッドの実装
    def find_by_id(self, entity_id: ItemSpecId) -> Optional[RecentTradesReadModel]:
        """IDでReadModelを検索"""
        return self._read_models.get(entity_id)

    def find_by_ids(self, entity_ids: List[ItemSpecId]) -> List[RecentTradesReadModel]:
        """IDのリストでReadModelを検索"""
        result = []
    ...
    def save(self, entity: RecentTradesReadModel) -> RecentTradesReadModel:
        """ReadModelを保存"""
    ...
    def find_all(self) -> List[RecentTradesReadModel]:
        """全てのReadModelを取得"""
        return list(self._read_models.values())


    # RecentTradesReadModelRepository特有メソッドの実装
    def find_by_item_name(self, item_name: str) -> Optional[RecentTradesReadModel]:
        """アイテム名で最近の取引履歴を取得"""
