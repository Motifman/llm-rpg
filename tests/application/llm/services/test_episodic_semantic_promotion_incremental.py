...
def test_incremental_promotion_matches_full_scan_for_triangle() -> None:
    ...
    def run(*, use_frontier: bool) -> list[str]:
        ...
        promo = EpisodicSemanticClusterPromotionService(episode_store=store, link_store=links, semantic_store=setup.semantic_store, promotion_frontier=frontier, expansion_hops=4)
