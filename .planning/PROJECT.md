...
- Current status:
  ...
  - v1.2 では `WorldSimulationService` の tick 責務分割と回帰ハーネス整備を完了し、milestone audit も `passed` になった
...
**Status:** 2026-03-14 に Phase 11-13 と milestone audit を完了。v1.2 はアーカイブ準備完了。
...
- [x] `WorldSimulationService` の tick 責務を段階的に分離し、既存 runtime path を維持する
- [x] 飢餓移住や actor behavior の業務ルールを policy / stage service に寄せて変更しやすくする
- [x] world simulation リファクタリングを支える回帰テスト基盤を整え、今後の分割を継続しやすくする
...
---
*Last updated: 2026-03-14 after v1.2 milestone audit passed*
