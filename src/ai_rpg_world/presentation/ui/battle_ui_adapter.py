...
from ai_rpg_world.presentation.ui.curses_battle_ui import CursesBattleUIManager
from ai_rpg_world.presentation.ui.pseudo_battle_ui import PseudoBattleUI, BattleUIManager
from ai_rpg_world.application.combat.handlers.enhanced_ui_battle_handler import UIBattleNotifier
...
def curses_main(stdscr):
    ...
    # ダミーの戦闘状態を作成
    from ai_rpg_world.application.combat.handlers.enhanced_ui_battle_handler import UIBattleState, ParticipantInfo
    ...
    # ダミーのアクション結果
    from ai_rpg_world.application.combat.handlers.enhanced_ui_battle_handler import UIActionResult, UIActionInfo, UITargetResult
