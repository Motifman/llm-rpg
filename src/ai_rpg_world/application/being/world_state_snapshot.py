...
top-level ``schema_version=4`` は、strict な subsystem 網羅検査に加えて
...
CURRENT_WORLD_SNAPSHOT_VERSION: int = 4
SUPPORTED_WORLD_SNAPSHOT_VERSIONS: frozenset[int] = frozenset({1, 2, 3, 4})
