...
def test_SlotIsEmptyError_は_ItemTransferException_の_子class() -> None:
    from ai_rpg_world.application.world_graph.spot_graph_item_transfer_service import (
        ItemTransferException,
        SlotIsEmptyError,
    )
...
def test_GroundItemGoneError_は_ItemTransferException_の_子class() -> None:
    from ai_rpg_world.application.world_graph.spot_graph_item_transfer_service import (
        GroundItemGoneError,
        ItemTransferException,
    )
...
def test_PickupSelfInventoryFullError_は_ItemTransferException_の_子class() -> None:
    from ai_rpg_world.application.world_graph.spot_graph_item_transfer_service import (
        ItemTransferException,
...
def test_drop_pickup_系_domain_error_は_LLM向け_error_code_を持つ() -> None:
...
def test_SlotIsEmptyError_の_message_は_日本語で_次アクションを示唆する() -> None:
...
def test_GroundItemGoneError_の_message_は_他プレイヤーに_先取り_を示唆する() -> None:
...
def test_PickupSelfInventoryFullError_の_message_は_drop提案を含む() -> None:
