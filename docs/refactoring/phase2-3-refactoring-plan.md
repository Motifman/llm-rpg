...
5. Phase B3e: `create_world_query_service` ファクトリを追加

**テスト**: `test_world_query_service.py`, `test_player_current_state_builder.py`, `test_visible_context_query_service.py`
