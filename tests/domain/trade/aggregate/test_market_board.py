...
どちらも板に残る。**線は「手番の外か」ではなく「引き金に人が居るか」**にある。
誰かが自分の注文を取ったから動いたのはよい (引き金に人が居て、通知も届く)。
engine が両者を勝手に選んで約定させるのはだめ (引き金に誰も居ないので、裁定に
気づく機会が消える)。世界が自分の手番の外で変わること自体は許される — 板越しの
取引では、自分が居ない場所で自分の品が売れる。
