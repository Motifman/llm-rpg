...
- [ ] **Phase B3a, B3a', B3b 実施済み**（2026-03-15: PlayerLocationQueryService, SpotContextQueryService, AvailableMovesQueryService の切り出し）
- **残**: Phase B3c（VisibleContextQueryService）, B3d（PlayerRuntimeContextBuilder 整理）, B3e（create_world_query_service ファクトリ）
