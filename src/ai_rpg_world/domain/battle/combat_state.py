...
from ai_rpg_world.domain.battle.battle_enum import Element, Race, ParticipantType, StatusEffectType, BuffType
from ai_rpg_world.domain.battle.constant import IF_DEFENDER_DEFENDING_MULTIPLIER as DEFENDER_DEFENDING_MULTIPLIER
from ai_rpg_world.domain.player.value_object.hp import Hp
from ai_rpg_world.domain.player.value_object.mp import Mp

if TYPE_CHECKING:
    from ai_rpg_world.domain.player.aggregate.player import Player
    ...
    from ai_rpg_world.domain.battle.events.battle_events import ParticipantInfo
