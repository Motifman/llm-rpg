...
class ItemEffect:
    ...
    def __str__(self):
        ...
        if self.gold_change != 0:
            effects.append(f"所持金{self.gold_change:+d}")
    ...
    def __repr__(self):
        return f"ItemEffect(hp_change={self.hp_change}, mp_change={self.mp_change}, gold_change={self.gold_change}, experience_change={self.experience_change}, temporary_effects={self.temporary_effects})" 